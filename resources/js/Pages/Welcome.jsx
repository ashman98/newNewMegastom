    ...
    return (
        <>
            ...
            <div className="bg-gray-50 text-black/50 dark:bg-black dark:text-white/50">
                <img
                    id="background"
                    className={`absolute -left-0 ${width < 960 ? width < 650 ? "bottom-[32%]" : "bottom-[18%]" : "bottom-[2%]"}  w-full `}
                    src={`${import.meta.env.VITE_APP_URL}back.png`}
                />
                <div className="relative flex min-h-screen flex-col items-center justify-center selection:bg-[#FF2D20] selection:text-white">
                    <div className="relativse w-full max-w-2xl px-6 lg:max-w-7xl">
                        ...
                        <main className="mt-6">
                            ...
                            <div className="flex lg:col-start-2 justify-center items-center">
                                <Link
